  ...
  stages {
    ...
    stage('fortify scan'){
      steps {
        ...
        sh 'ls'
        fortifyTranslate addJVMOptions: '', buildID: '${JOB_NAME}-${BUILD_NUMBER}', excludeList: '', logFile: './${JOB_NAME}-${BUILD_NUMBER}-translation.log', maxHeap: '1000', projectScanType: fortifyJava(javaAddOptions: '', javaClasspath: '', javaSrcFiles: '"./WebGoat/"', javaVersion: '1.8')
